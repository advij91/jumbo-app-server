...
import { generateAuthToken, generateRefreshToken, validateRefreshToken } from "../middleware/tokenService.mjs";
...
export const verifyUser = async (req, res) => {
    try {
        ...
        res.status(200).json({
            authToken, refreshToken, message: 'Tokens generated and saved successfully!'
        })
    } catch {
